...
__ZSH_AUTOPROXY_FTP_PROXY_ENABLED_PATTERN="FTPSEnable : 1"
__ZSH_AUTOPROXY_SOCKS_PROXY_ENABLED_PATTERN="SOCKSEnable : 1"
...
__ZSH_AUTOPROXY_FTP_PROXY_ENABLED=$__ZSH_AUTOPROXY_SCUTIL_PROXY[(I)$__ZSH_AUTOPROXY_FTP_PROXY_ENABLED_PATTERN]
__ZSH_AUTOPROXY_SOCKS_PROXY_ENABLED=$__ZSH_AUTOPROXY_SCUTIL_PROXY[(I)$__ZSH_AUTOPROXY_SOCKS_PROXY_ENABLED_PATTERN]
...
# ftp_proxy
if (( $__ZSH_AUTOPROXY_FTP_PROXY_ENABLED )); then
    __ZSH_AUTOPROXY_FTP_PROXY_SERVER=${${__ZSH_AUTOPROXY_SCUTIL_PROXY#*FTPProxy : }[(f)1]}
    __ZSH_AUTOPROXY_FTP_PROXY_PORT=${${__ZSH_AUTOPROXY_SCUTIL_PROXY#*FTPPort : }[(f)1]}
    export ftp_proxy="http://${__ZSH_AUTOPROXY_FTP_PROXY_SERVER}:${__ZSH_AUTOPROXY_FTP_PROXY_PORT}"
    export FTP_PROXY="${ftp_proxy}"
fi
# all_proxy
if (( $__ZSH_AUTOPROXY_SOCKS_PROXY_ENABLED )); then
    __ZSH_AUTOPROXY_SOCKS_PROXY_SERVER=${${__ZSH_AUTOPROXY_SCUTIL_PROXY#*SOCKSProxy : }[(f)1]}
    __ZSH_AUTOPROXY_SOCKS_PROXY_PORT=${${__ZSH_AUTOPROXY_SCUTIL_PROXY#*SOCKSPort : }[(f)1]}
    export all_proxy="http://${__ZSH_AUTOPROXY_SOCKS_PROXY_SERVER}:${__ZSH_AUTOPROXY_SOCKS_PROXY_PORT}"
    export ALL_PROXY="${all_proxy}"
elif (( $__ZSH_AUTOPROXY_HTTP_PROXY_ENABLED )); then
